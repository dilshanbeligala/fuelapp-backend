...
var ExitQueueAfterFuelPumpModelSchema=new Schema({
    vehicle_owner:{
...
const ExitQueueAfterFuelPump=mongoose.model('ExitQueueAfterFuelPump',ExitQueueAfterFuelPumpModelSchema);
module.exports={ExitQueueAfterFuelPump}